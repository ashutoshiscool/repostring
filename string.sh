...
# Automatically checks/installs dependencies via native package managers, configures MySQL,
# starts Spring Boot, and opens http://localhost:8080 in your default browser.

echo "=========================================================="
echo "Virtual Queue System - Linux & macOS Startup Script"
echo "=========================================================="
...
if command_exists java; then
    ...
    if [[ "$JAVA_VERSION" == 21* ]]; then
        ...
        echo "Java version is not 21. Installing OpenJDK 21..."
        INSTALL_JAVA=true
    fi
else
...
if [ "$STARTED" = true ]; then
    ...
    # Open default browser on Linux or macOS
